...
class CaffeSolver:
    ...
    def __init__(self, testnet_prototxt_path="/home/huangjb/guidedfilter1.0/res_net_model/test.prototxt",
                 trainnet_prototxt_path="/home/huangjb/guidedfilter1.0/res_net_model/train.prototxt", debug=False):
