...
#                print 'xxxx'
#                print height, width
                height_add_flag = height < self.resize_size[0]
                width_add_flag = width < self.resize_size[1]
...
#                crop_width = random.randint(int(width * self.crop_ratio), width)
                ...
                image_data = np.array(orignial_image_data[start_x : start_x + self.resize_size[0], start_y : start_y + self.resize_size[1]])
                image_labels = np.array(orignial_image_labels[start_x : start_x + self.resize_size[0], start_y : start_y + self.resize_size[1]])
                ...
                self.labels[i] = image_labels[np.newaxis]
#                das
